...
public class PackageServiceImpl implements PackageService {
    ...
    public Package getLatestVersion(String name) {
        try {
            ...
            Package latestPackage = packages.get(0);
            latestPackage.setDownloadUrl(awsS3Upload.getPreSignedUrl(latestPackage));
