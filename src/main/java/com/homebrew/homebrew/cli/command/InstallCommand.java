package com.homebrew.homebrew.cli.command;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.homebrew.homebrew.cli.model.PackageMetaData;
import com.homebrew.homebrew.cli.util.PackageManagerUtil;
...
public class InstallCommand implements Runnable {
    ...
    public void run() {
        try {
            ...
            PackageMetaData metadata = new ObjectMapper().readValue(conn.getInputStream(), PackageMetaData.class);
            URL s3Url = new URL(metadata.getS3Url());
